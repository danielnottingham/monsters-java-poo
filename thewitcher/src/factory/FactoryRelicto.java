...
public class FactoryRelicto extends MonsterFamilyFactory{
	...
	public Criature getCriature(MonsterClassEnum tipo) {
		switch (tipo) {
		case Kernun:
			return new Kernun("Kernun / Relicto", 8, 9, 10, "Não possui um terreno.");
		case Dopplers:
			return new Dopplers("Dopplers / Relicto", 5, 3, 2, "Pântano");
		case Silvano:
			return new Silvano("Silvano / Relicto", 3, 6, 1, "Montanhas");
		default:
			break;	
		}
